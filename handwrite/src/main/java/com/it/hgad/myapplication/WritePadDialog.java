package com.it.hgad.myapplication;
...
public class WritePadDialog extends Dialog {
    ...
    HandwritingActivity.DialogListener dialogListener;

    public WritePadDialog(Context context,HandwritingActivity.DialogListener dialogListener) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        p.height = (int) (height * 0.8);   //高度设置为屏幕的0.4
        p.width = (int) (width * 0.8);    //宽度设置为屏幕的0.6
