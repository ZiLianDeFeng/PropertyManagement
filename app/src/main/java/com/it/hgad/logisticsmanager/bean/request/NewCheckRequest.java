 ...
 */
public class NewCheckRequest extends BaseRequest {
    //参数名
    ...
    public NewCheckRequest(List<String> paramNames, List<String> paramValues, List<String> paramConditons, List<String> paramTypes, String rows, int pagenum) {
    ...
    public Map<String, String> getParams() {
        ...
        if (rows != null) {
            map.put("iDisplayLength", rows);
        }
        map.put("pageNum_", pagenum + "");
        return map;
    }
