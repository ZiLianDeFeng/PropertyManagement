...
import com.it.hgad.logisticsmanager.util.CommonAdapter;
 ...
 */
public class CaptrueAdapter extends CommonAdapter {
    /**
     * 用户选择的图片，存储为图片的完整路径
     */
    ...
    public CaptrueAdapter(Context context, List<String> mDatas, int itemLayoutId,
                          String dirPath) {
    ...
    @Override
    public void convert(ViewHolder helper, final Object item) {
