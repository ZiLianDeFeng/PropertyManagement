 ...
 */
public class CheckCensusRequest extends BaseRequest{
    private String startDate;
    private String endDate;

    public CheckCensusRequest(String startDate, String endDate) {
    ...
    public String getUrl() {
        ...
        return ip + "dataStatisAction!getInspectTopData.do";
    }
